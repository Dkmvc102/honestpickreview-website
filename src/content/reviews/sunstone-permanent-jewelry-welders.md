---
title: "Sunstone Permanent Jewelry Welders Review"
productName: "Sunstone Permanent Jewelry Welders"
brand: "Sunstone"
category: "tools-diy"
image: "/images/blog/sunstone/hero.png"
imageAlt: "Sunstone Permanent Jewelry logo"
rating: 4.4
priceRange: "$2,399 – $4,999 (starter kits)"
bestFor: "Entrepreneurs starting a permanent (welded) jewelry business"
shortSummary: "Micro-welding equipment and starter kits for entrepreneurs launching permanent jewelry businesses, including welders, certified chain, and safety equipment."
pros:
  - "20+ years of welding equipment expertise, made in USA"
  - "ISO 9001 and ETL safety certified"
  - "Kits bundle equipment, training, and inventory together"
  - "Optional mentorship program (PJ University) included in higher-tier kits"
cons:
  - "High upfront investment ($2,399–$4,999) before earning any revenue"
  - "Requires ongoing chain and findings inventory purchases beyond the initial kit"
  - "This is business equipment, not a casual consumer purchase — success depends heavily on the buyer's business execution"
specs:
  - label: "Core equipment"
    value: "Zapp / Zapp Plus 2 / Orion mPulse welders"
  - label: "Kit tiers"
    value: "Momentum, Dream, Legacy"
  - label: "Materials included"
    value: "Gold-filled and sterling silver certified chain, jump rings, connectors"
  - label: "Certifications"
    value: "ISO 9001, ETL safety certified"
faq:
  - question: "How fast can I recoup the cost of a starter kit?"
...
### Welders
The Zapp® and Zapp Plus® 2 (entry/mid-level) and Orion mPulse® (professional-grade) welders form the core equipment.
...
People seriously considering starting a permanent jewelry business — this is business startup equipment, not a casual hobby purchase, given the multi-thousand-dollar entry cost.

## Things to Know Before Buying

- This is a significant business investment — research your local market demand for permanent jewelry services before committing to a kit.
- Factor in ongoing costs beyond the starter kit: additional chain inventory, booth/event fees if selling at markets, and marketing.
- Compare kit tiers carefully — the jump from Momentum to Dream to Legacy is substantial in price, so match the tier to your actual business plan rather than defaulting to the top option.
